...
public class InpatientIO {
     ...
     */
    public static List<DiagnosisRelatedGroup> getDiagnosisRelatedGroups() {
        InpatientConnectionPool pool = InpatientConnectionPool.getInstance();
        Connection connection = pool.getConnection();
        CallableStatement callableStatement = null;
        ResultSet resultSet = null;
        List<DiagnosisRelatedGroup> diagnosisRelatedGroups = new ArrayList<>();
     ...
     */
    public static List<String> getStates(int drgId) {
        InpatientConnectionPool pool = InpatientConnectionPool.getInstance();
        Connection connection = pool.getConnection();
        CallableStatement callableStatement = null;
        ResultSet resultSet = null;
     ...
     */
    public static List<String> getCitiesToCompare(int drgId, String providerState) {
        InpatientConnectionPool pool = InpatientConnectionPool.getInstance();
        Connection connection = pool.getConnection();
        CallableStatement callableStatement = null;
        ResultSet resultSet = null;
     ...
     * @return the list of DRG definitions or null if an error occurs
     */
    public static List<DiagnosisRelatedGroup> getDiagnosisRelatedGroupsByRegion(String selectedState,
            String selectedCity) {
        InpatientConnectionPool pool = InpatientConnectionPool.getInstance();
        Connection connection = pool.getConnection();
        CallableStatement callableStatement = null;
     ...
     */
    public static List<InpatientComparisonResult> getRegionalResults(String state,
            String city, int drgId) {
        List<InpatientComparisonResult> results = new ArrayList<>();
        InpatientConnectionPool pool = InpatientConnectionPool.getInstance();
        Connection connection = pool.getConnection();
        CallableStatement callableStatement = null;
        ResultSet resultSet = null;
